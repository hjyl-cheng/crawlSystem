...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_alpkeskin_rota_core_internal_proxycontrol.Capacity"
                        }
                    },
                    "503": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_alpkeskin_rota_core_internal_models.GeoIPStatus"
                        }
                    },
                    "503": {
                        "description": "Service Unavailable",
    ...
    "definitions": {
        ...
        "github_com_alpkeskin_rota_core_internal_models.ProxyLifecycleSettings": {
            "type": "object",
            "properties": {
                "active_recheck_minutes": {
                    "type": "integer"
                },
                "auto_archive_enabled": {
                    "type": "boolean"
                },
                "hard_unreachable_after_hours": {
                    "type": "integer"
                },
                "soft_unreachable_after_hours": {
                    "type": "integer"
                },
                "youtube_unusable_after_hours": {
                    "type": "integer"
                }
            }
        },
        ...
        "github_com_alpkeskin_rota_core_internal_models.RotationSettings": {
            ...
            "properties": {
                "allowed_protocols": {
                    "description": "Empty means all supported protocols.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "github_com_alpkeskin_rota_core_internal_models.Settings": {
            ...
            "properties": {
                ...
                "geoip": {
                    "$ref": "#/definitions/github_com_alpkeskin_rota_core_internal_models.GeoIPSettings"
                },
                "healthcheck": {
                ...
                "proxy_lifecycle": {
                    "$ref": "#/definitions/github_com_alpkeskin_rota_core_internal_models.ProxyLifecycleSettings"
                },
                "rate_limit": {
        ...
        "github_com_alpkeskin_rota_core_internal_proxycontrol.Capacity": {
            ...
            "properties": {
                ...
                "roles": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/github_com_alpkeskin_rota_core_internal_proxycontrol.RoleCapacity"
                    }
                },
                "running": {
                    "type": "integer"
        ...
        "github_com_alpkeskin_rota_core_internal_proxycontrol.RoleCapacity": {
            "type": "object",
            "properties": {
                "assigned": {
                    "type": "integer"
